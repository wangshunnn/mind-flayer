...
- Capacity uses the latest successful step's input usage plus an estimate of replayable output and subsequent entries. Billing uses accumulated step usage separately. Cached input is not counted twice.
