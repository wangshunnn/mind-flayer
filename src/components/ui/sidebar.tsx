  ...
  return (
    <main
      ...
      className={cn(
        ...
        "sm:peer-data-[variant=inset]:m-1.5 sm:peer-data-[variant=inset]:ml-0 sm:peer-data-[variant=inset]:rounded-sm sm:peer-data-[variant=inset]:shadow-sm sm:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-1.5",
        className
      )}
      {...props}
    />
